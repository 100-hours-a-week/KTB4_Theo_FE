# 코드 한입
<img width="1348" height="383" alt="image" src="https://github.com/user-attachments/assets/6b4b04a2-6a9f-4385-95d7-28532194fa88" />
...
<p align="center">
  <img src="docs/images/loginpage.png" width="720" alt="코드 한입 로그인 화면" />
</p>

#### 회원가입

<p align="center">
  <img src="docs/images/signup_page.png" width="720" alt="코드 한입 회원가입 화면" />
</p>
...
<p align="center">
  <img src="docs/images/post_list_page.png" width="720" alt="코드 한입 게시글 목록 화면" />
</p>

#### 게시글 상세

<p align="center">
  <img src="docs/images/post_detail_page.png" width="720" alt="코드 한입 게시글 상세 화면" />
</p>
...
<p align="center">
  <img src="docs/images/post_write_page.png" width="720" alt="코드 한입 게시글 작성 화면" />
</p>

#### 게시글 수정

<p align="center">
  <img src="docs/images/post_edit_page.png" width="720" alt="코드 한입 게시글 수정 화면" />
</p>
...
<p align="center">
  <img src="docs/images/notification_list_page.png" width="720" alt="코드 한입 실시간 알림 목록 화면" />
</p>

#### 알림을 통한 댓글 확인

<p align="center">
  <img src="docs/images/comment_page.png" width="720" alt="코드 한입 알림 댓글 딥링크 화면" />
</p>
...
<p align="center">
  <img src="docs/images/user_update_page.png" width="720" alt="코드 한입 프로필 수정 화면" />
</p>
...
특히 JWT 인증과 SSE 실시간 알림을 연동하는 과정이 가장 기억에 남습니다. Access Token 만료 시 SSE 연결을 복구하고, 네트워크 단절이나 탭 비활성화로 발생할 수 있는 알림 누락을 서버 데이터와 다시 동기화하면서 실시간 기능은 연결 자체보다 재연결, 중복 방지, 데이터 정합성까지 함께 고려해야 한다는 점을 경험했습니다.

이번 프로젝트를 통해 기능이 정상적으로 동작하는 것에서 그치지 않고, 예외 상황에서도 안정적으로 복구되며 유지보수하기 쉬운 구조를 만드는 것이 중요하다는 것을 배웠습니다. 앞으로는 자동화된 테스트와 사용자 관점의 성능 측정을 보강하여 서비스의 안정성을 더욱 객관적으로 검증하고 싶습니다.
